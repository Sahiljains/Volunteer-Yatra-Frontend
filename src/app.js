...
import YatriPanel from "./components/YatriPanel/YatriPanel";
import ScheduleTrip from "./components/YatriPanel/ScheduleTrip";
			...
			<Router>
				<div className="page-wrapper">
					<Switch>
						...
						<Route path="/yatripanel" component={YatriPanel} />
						...
						<Route exact path="/paymentpage" component={ScheduleTrip}/>
