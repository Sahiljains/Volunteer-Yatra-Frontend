...
const filterOptions = [
  {
    name: 'Destinations',
    options: ['Rajasthan', 'Uttarakhand', 'Bihar', 'Himachal Pradesh', 'Jammu'],
    toAdd: 5,
  },
  {
    name: 'Host Type',
              ...
              {!isFilter
                ? [...Array(12)].map((_, index) => (
                    <div className='col-sm-4' key={index}>
                      ...
                      <Link to={`/travel-oppurtunities/${1}`}>
                        <p className='text-bold lead mt-2 mb-1'>{oppurtunity.title}</p>
                      </Link>
                      <h6 className='text-medium green-blue'>{oppurtunity.location}</h6>
